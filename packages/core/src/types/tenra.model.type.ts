import { AnyBulkWriteOperation, ClientSession, Collection, Db, Filter, UpdateFilter } from "mongodb";
import { TenraClient, TenraSchema } from "../lib-core";
import { Document } from "./document";
import { DbProvider, ModelContext, TenraContextState } from "./db.provider";
import { TenraMiddlewareOperation } from "./middleware/types";

/**
 * Options for configuring an Tenra model.
 * @template T - The type of the document in the model.
 */
export interface TenraModelOptions<T extends Document = any> {
...
export interface TenraHookPayload<T extends Document = Document> {
...
export interface TenraOperationMeta {
  /**
