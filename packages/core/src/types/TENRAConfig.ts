import { LoggerConfig } from '@Tenra/logger';
import { InitMultiTenancyOptions } from '../tanancy';
import { TenraModelOptions } from './tenra.model.type';
import { SchemaDefinition } from './schema.type';
import { Document } from './document';
import { BootstrapClient } from './bootstrapClient.type';


export interface TenraLoggerSettings extends LoggerConfig {
