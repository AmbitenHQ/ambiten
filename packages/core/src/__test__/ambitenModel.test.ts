import { AmbitenModel, AmbitenSchema } from "../lib-core";
...
describe('AmbitenModel', () => {
  ...
  let model: AmbitenModel<UserDoc>;
  ...
  beforeEach(async () => {
    ...
    model = new AmbitenModel({
      collectionName: 'testCollection',
      schema: new AmbitenSchema({} as Record<string, any>),
  ...
  describe('create', () => {
    it('should insert a document when valid data is provided', async () => {
      ...
      const mockSchema = new AmbitenSchema<TestDocument>({} as Record<string, any>);
    ...
    it('should throw validation error when invalid data is provided', async () => {
      ...
      const mockSchema = new AmbitenSchema<TestDocument>({
...
describe('AmbitenModel.updateWithTransaction', () => {
  ...
  it('should successfully update a document with a transaction', async () => {
    ...
    const schema = new AmbitenSchema<UserDoc>({} as Record<string, any>);
