...
describe('TenraSchema', () => {
	it('should be defined', () => {
		expect(TenraSchema).toBeDefined();
	});
	afterAll(async () => {
		jest.clearAllMocks();
	});
...
describe('schema', () => {
	let schema: TenraSchema<Document>;

	beforeEach(() => {
		schema = new TenraSchema<Document>({} as never);
	});
	...
	describe('constructor', () => {
		it('should create a new schema with a schemaDefinition', () => {
			...
			// Act
			const schema = new TenraSchema<Document>(schemaDefinition);
	...
	describe('validator', () => {
		it('should validate a document when all validators pass', () => {
			// Arrange
			const schema = new TenraSchema<Document>({} as never);
	...
	describe('index', () => {
		...
		it('should add a new index with fields and options to the indexes array', () => {
			// Arrange
			const testClass = {
				index: TenraSchema.prototype.index,
				indexes: []
			};
	...
	describe('addRelationship', () => {
		...
		it('should add a new relationship to the relationships array', () => {
			// Arrange
			const testClass = {
				addRelationship: TenraSchema.prototype.addRelationship,
				relationships: []
			};
