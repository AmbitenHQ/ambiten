...
function clearAllTimers() {
    return __awaiter(this, void 0, void 0, function () {
        var _i, intervals_1, id, _a, timeouts_1, id;
        return __generator(this, function (_b) {
            try {
                for (_i = 0, intervals_1 = intervals; _i < intervals_1.length; _i++) {
                    id = intervals_1[_i];
                    clearInterval(id);
                }
                for (_a = 0, timeouts_1 = timeouts; _a < timeouts_1.length; _a++) {
                    id = timeouts_1[_a];
                    clearTimeout(id);
                }
                intervals.clear();
                timeouts.clear();
                process.env.AMBITEN_LOGGER_METRICS_INTERVAL = '0';
            }
            catch (error) {
